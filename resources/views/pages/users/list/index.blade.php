        ...
        <div class="card-body">
            ...
            <table class="table table-bordered table-hover" id="kt_datatable">
                ...
                <tr>
                    ...
                    <td>{{$user->state}}</td>
                    <td>{{$user->country}}</td>
                    <td class="datatable-ct row">
                        <div class="col-md-6">
                        <a class="btn btn-primary" href="{{route('edit.user', $user->id)}}" ><i class="fa fa-edit"></i>Edit</a>

                        </div>                       
                         <div class="col-md-6">
                        <a href="" class="btn btn-danger" data-toggle="modal" data-target="#deleteClientModal{{ $user->id }}"><i class="fa fa-trash  "></i>delete</a>
     ...
     <div class="modal fade bs-example-modal-lg" id="deleteClientModal{{ $modal->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
       <div class="modal-dialog modal-lg" role="document">
         <div class="modal-content">
           ...
           <form class="form p-t-20" method="post" action="{{ route('delete.user', $modal->id)}}" >
